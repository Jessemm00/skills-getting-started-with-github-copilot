...
activities = {
    ...
    "Art Studio": {
        "description": "Explore painting, drawing, and sculpture with guidance from professional artists",
        "schedule": "Mondays and Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["grace@mergington.edu"]
    },
    "Debate Team": {
        "description": "Develop critical thinking and public speaking while competing in debates",
